...
class AddAddressScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder(init: ControllerAddAddress(),
        builder: (controller) {
          return Scaffold(
            appBar: AppBarCommon(titleColor: Colors.black,title: SmallText(text: "Enter area, city or country",color: Colors.black,size: 14,),centerTitle: false,color: AppColors.scaffoldBackgroundColor,elevation: 0,colorIconTheme: Colors.black,),
            body: Padding(
  ...
  searchBar(TextEditingController textEditingController){
    return GooglePlaceAutoCompleteTextField(
      ...
      inputDecoration: InputDecoration(prefixIcon: Icon(Icons.search,color: AppColors.primary,),contentPadding: EdgeInsets.only(top: 18),border: InputBorder.none,hintText: "Search for area, city or country",hintStyle: TextStyle(fontSize: 12)),
